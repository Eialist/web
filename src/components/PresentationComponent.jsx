  ...
  return (
    <div
      ...
      <p
        ...
        utvecklare. Mitt hjärta klappar för webbgränssnitt, användarupplevelse
        och pedagogik. Jag är en problemlösare med fokus på att hitta lösningar
        och få saker gjorda. Min kompetens inom Frontend-utveckling inkluderar
        HTML, CSS, Bootstrap, Sass, JavaScript, React, jQuery, GitHub, API:er,
